...
export function Footer() {
  return (
    <footer className="border-t border-white/10 bg-brand-navy py-12 md:py-16">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-brand-gray/70">
        ...
        <div className="mt-12 border-t border-white/10 pt-8 text-center text-sm text-brand-gray/50">
